...
export const videos = [
  ...
  // !startup
  {
    ...
    description:
      'Welcome to the first episode of our brand new show, Bits to Billions: The Unicorn Story, where we take you through the journey of some of India’s most prominent and successful entrepreneurs. In this episode,  Zeordha founder and CEO Nithin Kamath spoke to Moneycontrol’s Chandra R Srikanth on why he chose to build Zerodha differently – with zero debt, zero funding and zero loss. We also spoke to his A team: Nikhil Kamath and Dr Kailash NadhHe spoke to us about'
  },
  {
    _id: 'dKibwtAUq1s',
